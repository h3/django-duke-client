...
Creating a new project from scratch is easy as::
    ...
    $: duke startproject my-project-name
    $: cd my-project-name/
    $: ls
    README.rst  setup.py
...
You can see django duke also created different configuration files which will 
...
folder::
    ...
    (my-project-name)$: ls -a
    bootstrap.py  buildout.cfg  dev.cfg  .duke  myprojectname  
    my_project_name.egg-info  prod.cfg  README.rst  setup.py  src  versions.cfg
